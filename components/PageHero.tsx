...
export default function PageHero({
  ...
  return (
    <section className="relative flex min-h-[620px] items-center overflow-hidden border-b border-white/10 md:min-h-[680px] lg:min-h-[720px]">
      <img
        src={image}
        alt={imageAlt}
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#07110b]/70 via-[#07110b]/25 to-transparent" />

      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 py-24 md:px-6 lg:py-28">
