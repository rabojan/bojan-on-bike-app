...
export default function EditVinskoDozivetjePage() {
  ...
  const [trailType, setTrailType] = useState("Gravel");
  const [difficulty, setDifficulty] = useState("Lahka");
      ...
      <div className="space-y-8">
        ...
        <section className="flex flex-col gap-5 rounded-[36px] border border-white/10 bg-[#0b1a10] p-8 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/dozivetja/vinski-kolesarski-dan" target="_blank" className="rounded-full border border-white/10 bg-black/20 px-5 py-3 text-sm font-semibold text-zinc-300 transition hover:border-white/20">Predogled ↗</Link>
            ...
            <section className="rounded-[32px] border border-white/10 bg-black/20 p-7">
              ...
              <div className="space-y-5">
                <label className="block space-y-1.5">
                  ...
                  <input defaultValue="Med vinogradi in griči"
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    <label className="space-y-1.5">
                      ...
                      <input type="number" defaultValue="45" min="0" max="100"
                        className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-4 py-3 text-sm outline-none focus:border-[#c58b46]/60" />
                    </label>
                    <label className="space-y-1.5">
