...
const connectedTrails = [
  { name: "Gozdni flow nad Mariborom", distance: "700 m od trase", role: "Zgodovinska točka", selected: true },
      ...
      <div className="space-y-8">
        <section className="flex flex-col gap-5 rounded-[36px] border border-white/10 bg-[#0b1a10] p-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black">Stara planinska pot</h1>
          ...
          <div className="space-y-6">
            <div className="rounded-[32px] border border-white/10 bg-black/20 p-7">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <label className="space-y-2 md:col-span-2">
                  ...
                  <input defaultValue="Stara planinska pot" className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-5 py-4 outline-none focus:border-[#c58b46]/60" />
                </label>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {poiTypes.map((type) => (
                      <label key={type} className="flex items-center gap-3 rounded-2xl border border-white/10 bg-[#07110b] p-4">
                        <input type="checkbox" defaultChecked={["Zgodovina", "Wikipedia točka"].includes(type)} />
            ...
            <div className="rounded-[32px] border border-white/10 bg-black/20 p-7">
              ...
              <label className="space-y-2">
                ...
                <textarea
                  defaultValue="Zgodovinska pot, ki je bila v preteklosti glavna planinska povezava tega dela Pohorja."
                  rows={5}
              ...
              <label className="mt-5 block space-y-2">
                ...
                <textarea
                  placeholder="Dodaj širši zgodovinski kontekst, zgodbo poti ali zanimivosti..."
                  rows={6}
                  className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-5 py-4 leading-8 outline-none focus:border-[#c58b46]/60"
                />
              </label>
              <label className="mt-5 block space-y-2">
                ...
                <input
                  defaultValue="https://sl.wikipedia.org"
              ...
              <div className="overflow-hidden rounded-[28px] border border-white/10 bg-[#07110b]">
                <div className="flex min-h-[240px] items-center justify-center bg-black/20 p-8 text-center">
                  <div>
                    ...
                    <p className="mt-3 max-w-sm text-sm leading-7 text-zinc-400">Slika poti, znamenja ali zgodovinskega detajla.</p>
                  </div>
                </div>
            ...
            <div className="rounded-[32px] border border-white/10 bg-[#0b1a10] p-7">
              ...
              <div className="grid gap-5">
                <label className="space-y-2">
                  ...
                  <input defaultValue="Stara planinska pot, Pohorje" className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-5 py-4 outline-none focus:border-[#c58b46]/60" />
                </label>
                <div className="grid gap-5 sm:grid-cols-2">
                  <label className="space-y-2">
                    <span className="text-sm font-semibold text-zinc-300">Latitude</span>
                    <input defaultValue="46.5250" className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-5 py-4 outline-none focus:border-[#c58b46]/60" />
                  </label>
                  <label className="space-y-2">
                    <span className="text-sm font-semibold text-zinc-300">Longitude</span>
                    <input defaultValue="15.6100" className="w-full rounded-2xl border border-white/10 bg-[#07110b] px-5 py-4 outline-none focus:border-[#c58b46]/60" />
                  </label>
                </div>
              </div>
            </div>
                  ...
                  <div key={trail.name} className="rounded-2xl border border-white/10 bg-black/20 p-4">
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      <label className="space-y-2">
                        ...
                        <input defaultValue={trail.role} placeholder="npr. zgodovinska točka" className="w-full rounded-xl border border-white/10 bg-[#07110b] px-4 py-3 text-sm outline-none focus:border-[#c58b46]/60" />
                      </label>
                      <label className="space-y-2">
                        <span className="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500">Oddaljenost</span>
                        <input defaultValue={trail.distance} placeholder="npr. 700 m od trase" className="w-full rounded-xl border border-white/10 bg-[#07110b] px-4 py-3 text-sm outline-none focus:border-[#c58b46]/60" />
                      </label>
                    </div>
                  </div>
                ))}
