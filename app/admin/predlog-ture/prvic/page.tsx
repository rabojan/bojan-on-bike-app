    ...
    <AdminShell active="ture">
      <div className="space-y-8">
        ...
        <Section
          ...
          intro="Če prvič predlagaš turo, ustvari svoj ambasadorski profil. Če si že oddal predlog, se prijavi v svoj kotiček."
        >
          <div className="grid gap-5 xl:grid-cols-[1fr_0.9fr]">
            <div className="flex min-h-[300px] flex-col justify-between rounded-[26px] border border-white/10 bg-[#07110b] p-5">
              <div>
                ...
                <h3 className="mt-4 text-2xl font-black text-white">
                  Ustvari svoj ambasadorski profil
                </h3>

                <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-500">
                  Profil potrebuješ zato, da se tvoja tura shrani pod tvoje ime,
                  da lahko spremljaš status predlogov in da se ti pri objavljenih
                  turah šteje napredek do TOP ambasadorja.
                </p>
            ...
            <div className="flex min-h-[300px] flex-col justify-between rounded-[26px] border border-[#c58b46]/20 bg-[#c58b46]/10 p-5">
              <div>
                <div className="text-xs uppercase tracking-[0.28em] text-[#c58b46]">
                  Že imaš profil
                </div>
                ...
                <p className="mt-3 text-sm leading-7 text-zinc-300">
                  Po prijavi te čakajo tvoje oddane ture, objavljene ture,
                  predlogi, ki čakajo na objavo, in napredek do TOP ambasadorja.
                </p>
