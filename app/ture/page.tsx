          ...
          <div className="grid md:grid-cols-[1fr_auto] md:items-center">
            <div className="p-8 md:p-10">
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-400">
                Vsaka regija ima kolesarje, ki njene poti poznajo bolje kot
                kdorkoli drug. Pridruži se mreži lokalnih ambasadorjev — predlagaj
                ture, ki si jih prevozil, in pomagaj graditi zbirko, ki nosi tudi
                tvoj podpis.
              </p>
            </div>
