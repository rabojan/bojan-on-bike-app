...
const experience = {
  ...
  eyebrow: "Družinski izlet · Štajerska · Pohorje",
  ...
  highlights: [
    { icon: "👨‍👩‍👧", title: "Za vse starosti", text: "Pot je primerna za otroke na lastnih kolesih ali s sedežem od 6 let naprej." },
    { icon: "🔋", title: "E-bike prijazen", text: "Polnilnica pri Rudijevem domu — brez skrbi za doseg baterije." },
    { icon: "🌲", title: "Gozdni postanki", text: "Mirna mesta za počitek, malico in opazovanje narave med drevesi." },
  ],
  ...
  attraction: { name: "Pohorski gozdni odsek", href: "/znamenitosti/pohorski-gozdni-odsek" },
};
